    ...
    <div class="content-wrapper">
        ...
        <div class="card-body">
            <div class="card-header col-lg-9">
                <form class="form-inline" action="/incomeIndex?pageNum=1&rows=5&money=${condition.money[0]}&addtime=${condition.addtime[0]}&classif=${condition.classif[0]}&remark=${condition.remark[0]}">
                    ...
                    <div class="form-group">
                        ...
                        <label>类型：</label>
                        <div class="input-group-addon">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
                        <select id="classif" lay-filter="科目名称" name="classif" value="${condition.classif[0]}" style="width: 150px;height: 40px">
            ...
            <div class="card-header col-lg-3">
                ...
                <a href="/downAccounts?icategory=1">下载Excel</a>
            </div>
            <div id="jsGrid1">
                    ...
                    <c:forEach items="${pageInfo.list}" var="accounts" varStatus="index">
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="/deleteAccountsById?id=${accounts.id}&icategory=1">删除</a>
                            </td>
                        </tr>
                    </c:forEach>
                </table>
                ...
                <ul class="pagination pagination-sm m-0 float-right">
                    ...
                    <c:if test="${pageInfo.pageNum == 1}">
                        <li class="page-item disabled" >
                            <a class="page-link" href="/incomeIndex?pageNum=${(pageInfo.pageNum)-1}&rows=5&money=${condition.money[0]}&addtime=${condition.addtime[0]}&classif=${condition.classif[0]}&remark=${condition.remark[0]}">&laquo;</a>
                        </li>
                    </c:if>
                    <c:if test="${pageInfo.pageNum != 1}">
                        <li class="page-item">
                    ...
                    <c:forEach begin="1" end = "${pageInfo.totalPage}" step="1" var="i">
                        <c:if test="${pageInfo.pageNum == i}">
                            <li class="page-item disabled" >
                                <a class="page-link" href="/incomeIndex?pageNum=${i}&rows=5&money=${condition.money[0]}&addtime=${condition.addtime[0]}&classif=${condition.classif[0]}&remark=${condition.remark[0]}">${i}</a>
                            </li>
                        </c:if>
                        <c:if test="${pageInfo.pageNum != i}">
                            <li class="page-item">
                    ...
                    <c:if test="${pageInfo.pageNum != pageInfo.totalPage}">
                        <li class="page-item">
                            <a class="page-link" href="/incomeIndex?pageNum=${(pageInfo.pageNum)+1}&rows=5&money=${condition.money[0]}&addtime=${condition.addtime[0]}&classif=${condition.classif[0]}&remark=${condition.remark[0]}">&raquo;</a>
                        </li>
                    </c:if>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">添加单个记录</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <form action="/insertAccountsServlet?icategory=1" method="post" >
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label >科目类型：</label>
                                <select id="classif1" lay-filter="科目名称" name="classif" style="width: 466px;height: 40px">
                                    <option value="" >请选择科目</option>
                                    <c:forEach var="subject" items="${subjectList}">
                                        <option value="${subject.s_name }" >${subject.s_name }</option>
                                    </c:forEach>
