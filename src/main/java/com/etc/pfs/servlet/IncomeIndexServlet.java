...
@WebServlet("/incomeIndex")
public class IncomeIndexServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        PageInfo<Accounts> pageInfo =  service.selectAllIcategory("收入",loginUser.getUsername(),pageNum,rows,condition);
